...
class Custom_Host_Column_Entries(models.Model):
...
class Custom_Host_Columns(models.Model):
    id = models.SmallIntegerField(primary_key=True)
...
class CustomNetColumnEntries(models.Model):
    cc_id = models.SmallIntegerField()
    #cc_id = models.ForeignKey(CustomNetColumns, to_field='id', on_delete=models.CASCADE)
